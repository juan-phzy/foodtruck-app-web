...
export default function PublicMapPage() {
    ...
    const trucks = useQuery(api.trucks.getTrucksInViewportPublic, viewport);
    ...
    // Show sign-up prompt after 10 seconds
    useEffect(() => {
        if (isSignedIn) return; // Don't show prompt if user is signed in
    ...
    // Hide sign-up prompt after 8 seconds
    useEffect(() => {
        if (showSignUpPrompt) {
            const timer = setTimeout(() => {
        ...
        <div className={styles.mapPageWrapper}>
            ...
            {showSignUpPrompt && (
                <div className={styles.signUpPrompt}>
                    <p>Discover more features by creating an account!</p>
                    <div className={styles.signUpPromptButtons}>
                        <Link
                            href="/auth/sign-up"
            ...
            {/* Enhanced truck details panel when a truck is selected */}
            {selectedTruck && (
                <div className={styles.enhancedTruckInfoPanel}>
                    <button
                    ...
                    <div className={styles.truckInfoCta}>
                        <p>
                            To view full menu, hours, and more information about
                            this truck:
                        </p>
                        <div className={styles.truckInfoButtons}>
                            {isSignedIn ? (
                                <Link
                                    href="/user/map"
                                    className={styles.truckInfoSignUp}
                                >
                                    Enter App
                                </Link>
                            ) : (
                                <>
                                    ...
                                    <Link
                                        href="/auth/sign-in"
                                        className={styles.truckInfoSignIn}
                                    >
                                        Sign In
                                    </Link>
                                </>
