...
export default function UserSignUpPage() {
    ...
    const { data, updateField, reset } = useUserOnboardingStore();
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            if (result.status === "complete") {
                ...
                // Save the user data to Convex (this would be a separate step in your application)
                // For now, we're just clearing the store and redirecting
                reset();
                ...
                // This is the key fix - force a reload to ensure the session is fully established
                window.location.href = "/user/map";
                // This will cause a full page reload rather than using router.replace
                // which ensures Clerk has time to set up the session properly
            } else {
                setLoading(false);
                    ...
                    <>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            <input
                                ...
                                type="tel"
                                className={styles.input}
                                value={data.phone_number || ""} // Ensure it's never undefined
                                onChange={(e) =>
                    ...
                    <>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            <input
                                ...
                                type="password"
                                className={styles.input}
                                value={data.password || ""} // Ensure it's never undefined
                                onChange={(e) =>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            <input
                                ...
                                type="password"
                                className={styles.input}
                                value={confirmPassword} // Use state for confirm password
                                onChange={(e) =>
                ...
                <div className={styles.card}>
                    ...
                    {currentStep < 5 && (
                        <p className={styles.subtitle}>
                            Join MunchMap to discover local food trucks
                        </p>
                    )}
